...
final class FeedViewControllerTests: XCTestCase {
    ...
    func test_feedImageView_cancelsImageURLWhenVisible() {
        let image0 = makeImage(url: URL(string: "http://url-0.com")!)
        let image1 = makeImage(url: URL(string: "http://url-1.com")!)
        let (sut, loader) = makeSUT()
    ...
    private func assertThat(_ sut: FeedViewController, hasViewConfiguredFor image: FeedImage, at index: Int, file: StaticString = #file, line: UInt = #line) {
        ...
        XCTAssertEqual(cell.locationText, image.location, "Expected location text to be \(shouldLocationBeVisible) for image view at (\(index))", file: file, line: line)
        XCTAssertEqual(cell.descriptionText, image.description, "Expected description text to be \(shouldLocationBeVisible) for image view at (\(index))", file: file, line: line)
    }
